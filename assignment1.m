...
%
% Answer: The command 'clear all' clears or deletes the workspace.
%
...
% 4. What command would you type to see a list of all installed toolboxes?
        ...
        %<- The command I would type to see a list of installed 
        % toolboxes is "ver"; 
...
'help images'; 
%ChatGPT explained that the command "help images" would return a list of 
%all available functions in the image processing toolbox.
...
%
% Answer: 'ttest(x)'; 
% This function performs the t-test to compare means for a one sample
% t-test. 
...
%
% Answer: The for and while are the two major loops that MATLAb supports.
% The for loop is used  to repeat calculations a certain amount of times
% and the while loop is used to repeat calculations until a certain
...
%
% Answer: NaN stands for not a number. It represents undefined numerical
% results. an example would be zero devided by zero. 
%
...
'xpbombs';
%ChatGPT explained that a hidden game  xpbombs, is similar to the minesweeper
%game 
...
'orginalWeightLbs=orginalweightkg*2.205' ;
'originalWeightLbs=220.5000';
'originalWeightOz = originalWeightkg * 35.274' ; 
'orinialWeightOz=3.2274e+03';
...
'originalVec=([-10,10], 1, 5)';
% - subtract 3 from each element
'subtractVec= originalVec-3';

% - count how many are positive
'positiveCount=sum(orginalVec>0)';

% - get the absolute value of each element

'absVec=abs(orginalVec)';
...
% ROI.
'totalRevenues=input(2000)';
'totalCosts=input(500)';
...
'display(Hello World)'; 
'userInputText=(Hello World)';
'userOutputText=(userInputText)';
