...
%
% Answer: for and while are the two major loops that MATLAb supports. for
% is (search loops on help app)
% 
...
%
% Answer: NaN stands for not a number. (look on help part for example)
%
...
orignalWeightLbs = originalWeightkg * 2.205 ;
